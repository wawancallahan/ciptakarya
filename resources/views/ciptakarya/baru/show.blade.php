...
@section ('content')
    ...
    <div id="accordion">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header" data-toggle="collapse" data-target="#perhitungan">
                <h4 class="card-title">
                    Perhitungan
                </h4>
            </div>
            
            <div id="perhitungan" class="collapse show" data-parent="#accordion">
                <div class="card-body">
                    <div class="form-group row">
                        <p class="col-sm-4">Jenis Bangunan</p>
                        <p class="col-sm-8">{{ ucwords($item->ciptaKarya->jenis ?? '') }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Tipe</p>
                        <p class="col-sm-8">{{ $item->ciptaKarya->tipe_format ?? '' }}</p>
                    </div>
                    ...
                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Depan</p>
                        <p class="col-sm-8">{{ $item->ciptaKarya->pagar_depan ?? '' }} M</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Belakang</p>
                        <p class="col-sm-8">{{ $item->ciptaKarya->pagar_belakang ?? '' }} M</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Samping</p>
                        <p class="col-sm-8">{{ $item->ciptaKarya->pagar_samping ?? '' }} M</p>
                    </div>

                    <label>Hasil</label>
                    <hr>
                    <div class="form-group row">
                        <p class="col-sm-4">Harga (m^2)</p>
                        <p class="col-sm-8">{{ number_format($total['total'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Depan/T: 1,5M (m)</p>
                        <p class="col-sm-8">{{ number_format($total['total_pagar_depan'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Belakang/T: 3M (m)</p>
                        <p class="col-sm-8">{{ number_format($total['total_pagar_belakang'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Samping/T: 2M (m)</p>
                        <p class="col-sm-8">{{ number_format($total['total_pagar_samping'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Harga (m^2) Non Standar</p>
                        <p class="col-sm-8">{{ number_format($total['total_non_standar'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Depan/T: 1,5M (m) Non Standar</p>
                        <p class="col-sm-8">{{ number_format($total['total_pagar_depan_non_standar'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Belakang/T: 3M (m) Non Standar</p>
                        <p class="col-sm-8">{{ number_format($total['total_pagar_belakang_non_standar'] ?? 0) }}</p>
                    </div>

                    <div class="form-group row">
                        <p class="col-sm-4">Pagar Samping/T: 2M (m) Non Standar</p>
                        <p class="col-sm-8">{{ number_format($total['total_pagar_samping_non_standar'] ?? 0) }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-primary card-outline">
            ...
            <div id="satu" class="collapse" data-parent="#accordion">
                <div class="card-body">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header" data-toggle="collapse" data-target="#dua">
                ...
                <div class="card-tools">
                    <a href="{{ route('baru-edit-dua', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <p class="col-sm-8">
                            ...
                            @if ($file_surat_kepemilikan_bangunan !== null && file_exists(public_path() . '/uploads/file_surat_kepemilikan_bangunan/' . $file_surat_kepemilikan_bangunan->file))
                                <a href="{{ public_path() . '/uploads/file_surat_kepemilikan_bangunan/' . $file_surat_kepemilikan_bangunan->file }}" class="btn btn-info btn-xs" download>Download File</a>
                            @endif
                        </p>
                    </div>
        ...
        <div class="card card-primary card-outline">
            <div class="card-header" data-toggle="collapse" data-target="#tiga">
                ...
                <div class="card-tools">
                    <a href="{{ route('baru-edit-tiga', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                </div>
            </div>
        ...
        <div class="card card-primary card-outline">
            <div class="card-header" data-toggle="collapse" data-target="#empat">
                ...
                <div class="card-tools">
                    <a href="{{ route('baru-edit-empat', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                </div>
            </div>
        ...
        <div class="card card-primary card-outline">
            <div class="card-header" data-toggle="collapse" data-target="#lima">
                ...
                <div class="card-tools">
                    <a href="{{ route('baru-edit-lima', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                </div>
            </div>
        ...
        <div class="card card-primary card-outline">
            <div class="card-header" data-toggle="collapse" data-target="#enam">
                ...
                <div class="card-tools">
                    <a href="{{ route('baru-edit-enam', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                </div>
            </div>
