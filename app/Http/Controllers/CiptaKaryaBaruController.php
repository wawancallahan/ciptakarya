...
class CiptaKaryaBaruController extends Controller
{
    use FileUpload;
    ...
    {
        return view('ciptakarya.baru.create');
    }
    ...
    public function gedung () {
        ...
        return view('ciptakarya.baru.create_gedung')->with([
            'gedungs' => $gedungs,
            'pagarGedungNegaras' => $pagarGedungNegaras,
        ]);
    }
    ...
    public function rumah () {
        ...
        return view('ciptakarya.baru.create_rumah')->with([
            'rumahNegaras' => $rumahNegaras,
            'pagarRumahNegaras' => $pagarRumahNegaras,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            CiptaKarya::create([
                ...
                'pagar_depan' => str_replace(',', '', $request->panjang_depan),
                'pagar_belakang' => str_replace(',', '', $request->panjang_belakang),
                'pagar_samping' => str_replace(',', '', $request->panjang_samping),
                'bangunan_id' => $item->id
            ]);
            ...
            return redirect()->route('ciptakaryabaru.index');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    {
        $item = Bangunan::with('saranaBangunan', 'ciptaKarya')->find($id);

        if ($item === null) {
            return redirect()->route('ciptakaryabaru.index');
        }

        $total = $item->ciptaKarya->total_format ?? [];
    ...
    public function editSatu ($id) {
        ...
        if ($item === null) {
            return redirect()->route('ciptakaryabaru.show', $id);
        }

        return view('ciptakarya.baru.edit_satu')->with([
            'item' => $item
        ]);
    }
    ...
    public function editDua ($id) {
        ...
        return view('ciptakarya.baru.edit_dua')->with([
            'item' => $item
        ]);
    }
    ...
    public function editTiga ($id) {
        ...
        return view('ciptakarya.baru.edit_tiga')->with([
            'item' => $item
        ]);
    }
    ...
    public function editEmpat ($id) {
        ...
        return view('ciptakarya.baru.edit_empat')->with([
            'item' => $item
        ]);
    }
    ...
    public function editLima ($id) {
        ...
        return view('ciptakarya.baru.edit_lima')->with([
            'item' => $item
        ]);
    }
    ...
    public function editEnam ($id) {
        ...
        return view('ciptakarya.baru.edit_enam')->with([
            'bangunan' => $bangunan,
            'item' => $item
        ]);
    }
    ...
    public function editTujuh ($id) {
        ...
        return view('ciptakarya.baru.edit_tujuh')->with([
            'item' => $item
        ]);
    }
    ...
    public function editCatatan ($id) {
        ...
        return view('ciptakarya.baru.edit_catatan')->with([
            'item' => $item
        ]);
    }
    ...
    public function editRekomendasi ($id) {
        ...
        return view('ciptakarya.baru.edit_rekomendasi')->with([
            'item' => $item
        ]);
    }
